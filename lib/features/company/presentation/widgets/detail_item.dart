        ...
        child: Row(
          children: [
            ...
            Expanded(
                child: Text(
              widget.text,
              style: context.textStyle.detailText.copyWith(color: context.color.accountInfoColor),
            )),
            Expanded(
              child: EditableText(
                controller: textEditingController,
                focusNode: FocusNode(),
                style: context.textStyle.detailText.copyWith(color: const Color(0xff09093b)),
